...
import argparse
from queue_based.keras_extract_embedding_worker import KerasExtractEmbeddingWorker
import pandas as pd
...
def run_extract_emebddings(df, gpuids=[0,1],checkpoint='../../chinese_L-12_H-768_A-12/'):
    #scan all files
    xdatalist = list()
    for xdata in df.interrows():
        xdatalist.append((xdata['id'],xdata['content']))
...
if __name__ == "__main__":
    ...
    run_extract_emebddings(df, gpuids)
